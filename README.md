...
```dotenv
# REQUIRED — at least one LLM provider key. Defaults route to Together AI.
TOGETHER_API_KEY=tgp_v1_...

# OPTIONAL — additional providers, picked automatically by LiteLLM based on
# the configured model prefix below.
# OPENAI_API_KEY=
# ANTHROPIC_API_KEY=
# GEMINI_API_KEY=
...
# OPTIONAL — Brave Search API key. Specialist agents use it as a tool to
# verify unknown companies / technologies / institutions.
BRAVE_API_KEY=
...
# Use LiteLLM-style prefixes (the provider is inferred from the prefix):
#   together_ai/openai/gpt-oss-20b
#   together_ai/meta-llama/Llama-3.3-70B-Instruct-Turbo
#   openai/gpt-4o                (needs OPENAI_API_KEY)
#   anthropic/claude-sonnet-4-6  (needs ANTHROPIC_API_KEY)
#   gemini/gemini-2.0-flash      (needs GEMINI_API_KEY)
# Defaults: parser/aggregator on gpt-oss-20b, specialists on Llama-3.3-70B.
# CV_SCREENER_MODEL_PARSER=together_ai/openai/gpt-oss-20b
# CV_SCREENER_MODEL_SPECIALIST=together_ai/meta-llama/Llama-3.3-70B-Instruct-Turbo
# CV_SCREENER_MODEL_AGGREGATOR=together_ai/openai/gpt-oss-20b
# CV_SCREENER_MODEL_CHAT=together_ai/openai/gpt-oss-20b
```
